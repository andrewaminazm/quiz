...
describe('regression trumarket', function(){
    it('new request  ', function(){
        ...
        cy.log('1-login 2-add a new reqeust 3- fill pop-over menu and click continue  4- fill cfc application field 5- click get quote 6-click attachment button ')
        ...
        cy.wait(4000)
        cy.get(':nth-child(2) > .ant-form-item-control > .ant-form-item-control-input > .ant-form-item-control-input-content > .tru-text-input').type('bnnwesnnaasx@gmail.com',{force: true});
        cy.wait(4000)
        ...
        cy.wait(4000)
        cy.get(':nth-child(3) > .ant-form-item-control > .ant-form-item-control-input > .ant-form-item-control-input-content > .tru-text-input').type('aasswsq',{force: true});
        cy.wait(4000)
        ...
        /* ==== End Cypress Studio ==== */
        /* ==== Generated with Cypress Studio ==== */
        cy.get('.outlined > span > .tru-icon').click({force:true});
        /* ==== End Cypress Studio ==== */
    })
