...
describe('regression trumarket', function(){
    it('new request  ', function(){
     ...
     cy.wait(8000)
        ...
        /* ==== Generated with Cypress Studio ==== */
        cy.get('.elements > :nth-child(3) > span').click();
        cy.get(':nth-child(1) > .tru-form-item > .tru-column > .tru-textarea').click({force:true}).type('andrewamin878@gmail.com');
        cy.get(':nth-child(2) > .tru-form-item > .tru-column > .tru-textarea').click({force:true}).type('andrew.a@trufla.com');
