...
describe('regression trumarket', function(){
    it('quickadd new request  ', function(){
        cy.log('quickadd request ')
        cy.log('1-login 2-add a new reqeust 3- fill pop-over menu and click quickadd ')
        ...
        cy.wait(5000)
        cy.get('.btn-actions-container > div > .primary').click({force:true})
        cy.wait(7000)
        /* ==== End Cypress Studio ==== */
        /* ==== Generated with Cypress Studio ==== */
